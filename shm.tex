...
% \vspace*{1cm}
    \begin{center}
      ...
      \titrfont \textbf{پیاده سازی \lr{real-time 3D engine}}\par}
...
\fontsize{13}{0.8cm}\mitrafont
  همزمان با پیدایش کامپیوتر ها، تلاش ها برای بهره بردن از توان آنها برای ساخت ابزار های تصویر کردن\footnote{\lr{visualize}} داده هاو ابزار های مربوطه برای
