...
\begin{figure}[H]
    \centering
        \includegraphics[width=8cm]{images/logoEN.png}
\end{figure}
    ...
    \begin{center}
      ...
      {\fontsize{13}{1cm} \selectfont \myfont \textbf{تاریخ: 1400/6/28}}
    \end{center}
...
\begin{figure}[ht]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{لوگو \lr{GLFW}}}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{متصل کردن \lr{vertex attribute}}}
    \label{fig:my_label}
\end{figure}
\vspace*{0.6cm}
...
\begin{figure}[ht]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{اولین مثلث}}
    \label{fig:my_label}
\end{figure}
\vspace*{0.3cm}
...
\begin{figure}[ht]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{رنگ ها و مثلث}}
    \label{fig:my_label}
\end{figure}
\vspace*{0.3cm}
...
\begin{figure}[ht]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{افزودن جزئیات به مثلث}}
    \label{fig:my_label}
\end{figure}
\newpage
...
\begin{figure}[ht]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{شرح \lr{perspective frustum}}}
...
glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{مکعب های سه بعدی}}
    \label{fig:my_label}
\end{figure}
% end of section ---------------------
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{روش \lr{blinn-phong shading}}}
    \label{fig:blin}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{\lr{specular map} مربوط به یک اسلحه }}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{استفاده از \lr{phong-shading}}}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{سایه - غیاب نور}}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{یک صحنه به همراه سایه}}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{تماشای مدل ها در \lr{Microsoft 3D viewer}}}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{تماشای مدل در پروژه من}}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{نسخه اصلی \lr{Flappy Bird}}}
    \label{fig:my_label}
\end{figure}
...
GET_MODEL(0)->DrawInstances(pipes_pos, nullptr);
    ...
    \caption{\fontsize{11pt}{1.0cm}\zarbold\textbf{پیاده سازی\lr{Flappy Bird} به وسیله پروژه}}
    \label{fig:my_label}
\end{figure}
...
\begin{latin}
    - Peter shirley and S. Marschner, "Fundamentals of Computer Graphics", Third Edition, May 2009\\
    - Ian Millington, "Game Physics Engine Development", 2007\\
    - Joey de Vries, "Learn OpenGL, Graphics Programming", First Edition, 2020\\
    - unknown writer "opengl-tutorial", (available on \hyperlink{http://www.opengl-tutorial.org/}{http://www.opengl-tutorial.org} visited at 2021)\\
    - The Cherno "Welcome To OpenGL", (available on \hyperlink{https://youtu.be/W3gAzLwfIP0}{https://youtu.be/W3gAzLwfIP0} visited at 2020)
\end{latin}
% end of references
% start of English abstract
\newpage
\thispagestyle{empty}
\begin{latin}
    \fontsize{18}{1cm}\textbf{Abstract}:\\
    At the same time as inventing computers, computer scientists have made efforts to make use of computers in various fields such as visualizing tools, military, entertainment fields and video games industry.\par
    Designing and implementing 3D render Engines needs some knowledge of 3D mathematics and Graphic processors in general.\par
    The goal of this project is to study and implement a Real-time 3D Render Engine and will review techniques and methods in this field for various use cases, render engines are the main building block in real-world simulators,  video games, and much more industries that have been categorized in multiple categories, in this project we will focus on a special category, real-time render engines that have many benefits. also in the last section, I'll give you some examples and use cases. 
\end{latin}
% end of English abstract

% start of English Cover
\newpage
\thispagestyle{empty}
...
% \vspace*{1cm}
    \begin{center}
      \large
      {\fontsize{12}{1cm} \selectfont \textbf{\lr{Shahid Bahonar University of Kerman}}\par}
      {\fontsize{11}{1cm} \selectfont \textbf{\lr{Faculty of Engineering}}\par}
      {\fontsize{14}{1cm} \selectfont \textbf{\lr{B.Sc. Thesis}}\par}
      {\fontsize{16}{1cm} \selectfont \textbf{\lr{Implement a Real-time Render Engine}}\par}
      {\fontsize{14}{1cm} \selectfont \textbf{\lr{Supervisor : Dr F.Ghasemian}}\par}
      {\fontsize{14}{1cm} \selectfont \textbf{\lr{By: Ahmad Mansoori}}\par}
      {\fontsize{13}{1cm} \selectfont \textbf{\lr{Date : 9/18/2021}}}
    \end{center}
