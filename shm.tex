...
\normalsize
    ...
    در زمان کار با \lr{blender} و در صحنه های بزرگ و شلوغ با استفاده از \lr{Eevee} می توانیم با سرعت بالا دسترسی به اکثر جزئیات و ویژگی های صحنه خود داشته باشیم، اینکار بدون استفاده از  یک \lr{real time renderer} مانند \lr{Eevee} پروسه ای بسیار زمان بر و شامل آزمون و خطاهای زیادی می باشد که هزینه هایی زیادی از نظر مالی و نیروی انسانی به جای می گذارد، \lr{Eevee} به صورت ماژولار و منطبق با قرارداد های \lr{Blener} ساخته شده. همچنین \lr{Eevee}  از \lr{openGL} و تکنیک های \lr{render}  استفاده شده در صنعت بازی سازی موفقیت های زیادی کسب کرد.\par
